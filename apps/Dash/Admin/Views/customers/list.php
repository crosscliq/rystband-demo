<div class="row">
	...
	<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="./admin/customer/create">Add New</a>
            </li>
        </ul>            	
	</div>
</div>
        ...
        <?php if (!empty($paginated->items)) { ?>
            ...
            <?php foreach($paginated->items as $item) { ?>
                <tr>
                    ...
                    <td class="">
                        <a href="./admin/customer/edit/<?php echo $item->id; ?>">
                    ...
                    <td class="text-center">
                        <a class="btn btn-xs btn-secondary" href="./admin/customer/edit/<?php echo $item->id; ?>">
                            <i class="fa fa-pencil"></i>
                        </a>
	                    &nbsp;
	                    <a class="btn btn-xs btn-danger" data-bootbox="confirm" href="./admin/customer/delete/<?php echo $item->id; ?>">
