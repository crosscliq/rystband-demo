...
<form id="detail-form" action="./admin/customers/group/update/<?php echo $item->get( $model->getItemKey() ); ?>" class="form-horizontal" method="post">
    ...
    <div class="clearfix">
        ...
        <div class="pull-right">
            ...
            &nbsp; <a class="btn btn-default" href="./admin/customers/groups">Cancel</a>
        </div>
